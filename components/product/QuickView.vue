...
const { toggleQuickView } = store;

const { product: fullProduct, showProductView } = storeToRefs(store);

/* TODO: Get product info */
</script>

<template>
  <TransitionRoot as="template" :show="showProductView">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <NuxtImg
                      :src="fullProduct?.imageGroups[0].images[0].disBaseLink"
